  ...
  return (
    <footer className='footer-container'>
      <div>
        ...
        <a href="https://github.com/AnthonyMickaelAlexis/visual-barbell-calculator" target="_blank" rel="noopener noreferrer"><h5>Enhanced Version by Anthony Mickael Alexis</h5>
          <div className='footer-repo-container'>
            <div className='footer-icon-container'>
              <img src={forkIcon} className="footer-icon-fork" alt="instagram icon" />
              <div className='footer-repo-info'>{` ${repoInfo[0]}`}</div>
