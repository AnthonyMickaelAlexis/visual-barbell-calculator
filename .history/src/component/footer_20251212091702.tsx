...
const Footer: React.FC = () => {
  ...
  return (
    <footer className='footer-container'>
      <a href="https://github.com/jbberinger/visual-barbell-calculator" target="_blank" rel="noopener noreferrer"><h5>Designed & Built by Justin Beringer | Enhanced by Anthony Mickael Alexis</h5>
